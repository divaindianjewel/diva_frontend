...
const page = () => {
  return (
    <div className="container py-8">
      ...
      <p>
        This website is operated by Diva the indian jewel. Throughout the site,
        the terms “we”, “us” and “our” refer to Diva the indian jewel. Diva the
        indian jewel offers this website, including all information, tools and
        ...
        changes. Our store is hosted on Shopify Inc. They provide us with the
